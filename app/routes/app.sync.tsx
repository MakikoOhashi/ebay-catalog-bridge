...
const textMap = {
  ja: {
    ...
    accountConnectionsDesc: "どのeBayアカウントをShopifyストアに紐づけるかを管理します。同期された商品には、eBay ID のタグが自動で付きます。",
  ...
  en: {
    ...
    accountConnectionsDesc: "Manage which eBay accounts are linked to this Shopify store. Synced products automatically receive an eBay ID tag.",
      ...
      <s-section accessibilityLabel={t.step4} heading="">
        ...
        <div style={{ marginTop: 16 }}>
          <details style={{ borderRadius: 12, border: "1px solid var(--s-color-border-default)", padding: 16 }}>
            <summary style={{ cursor: "pointer", fontWeight: 700 }}>{t.runHistoryTitle}</summary>
